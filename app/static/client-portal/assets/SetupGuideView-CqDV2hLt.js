...
});`,f=`<script src="${k}/t.js?key=${g||"YOUR_PUBLIC_TRACKER_KEY"}" defer><\/script>`,w=`// 1. Identify User (before firing events, e.g. on checkout, login, or registration)
capi('setUser', {
...
capi('track', 'AddToCart', {
  ...
  content_ids: ['prod_99'],
  content_type: 'product'
});`,j=`// Server-to-Server Conversions API (e.g. Node.js / Laravel / Python)
// POST ${l}/events
